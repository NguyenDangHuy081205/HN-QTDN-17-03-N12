...
<p align="center">
    <img src="images/phongban.jpg" alt="Quản lý phòng ban" width="800"/>
</p>
...
<p align="center">
    <img src="images/phonghop.jpg" alt="Quản lý phòng họp" width="800"/>
</p>
...
<p align="center">
    <img src="images/muonphong.jpg" alt="Quản lý đặt phòng" width="800"/>
</p>
...
<p align="center">
    <img src="images/thongke.jpg" alt="Biểu đồ cột thống kê" width="800"/>
</p>
...
<p align="center">
    <img src="images/thongkee.jpg" alt="Biểu đồ tròn thống kê" width="800"/>
</p>
...
<p align="center">
    <img src="images/Poster.png" alt="Poster Hệ thống Quản lý tài sản và Phòng họp" width="900"/>
</p>
...
Phần **Giới thiệu** trình bày bài toán thực tế, những khó khăn trong việc quản lý tài sản và phòng họp theo phương pháp thủ công, đồng thời đưa ra giải pháp xây dựng hệ thống ERP trên nền tảng Odoo 15 với các tính năng nổi bật như quản lý tài sản, quản lý phòng họp, dashboard thống kê và phân quyền người dùng.

Tiếp theo, phần **Kiến trúc hệ thống** mô tả mô hình hoạt động của hệ thống, thể hiện mối liên kết giữa cơ sở dữ liệu, các module nghiệp vụ, Odoo ERP Core và giao diện người dùng. Điều này giúp người xem hiểu rõ cấu trúc và quy trình xử lý dữ liệu của hệ thống.

Phần **Giao diện ứng dụng** minh họa các màn hình tiêu biểu của hệ thống như quản lý tài sản, quản lý phòng họp, đăng ký sử dụng phòng họp và các biểu mẫu xử lý nghiệp vụ, qua đó thể hiện tính trực quan và khả năng đáp ứng nhu cầu quản lý trong doanh nghiệp.

Bên cạnh đó, poster còn giới thiệu **Công nghệ sử dụng**, bao gồm hệ điều hành Ubuntu, Odoo 15, Python, JavaScript (OWL), XML/QWeb, PostgreSQL cùng các thư viện hỗ trợ phục vụ quá trình phát triển hệ thống. Cuối cùng, phần **Hướng phát triển** đề xuất các định hướng mở rộng như tự động hóa quy trình nghiệp vụ, tích hợp AI, đồng bộ với các phân hệ khác của Odoo và tăng cường bảo mật dữ liệu nhằm nâng cao hiệu quả quản lý trong tương lai.
